...
printf "\nNearest neighbours of %s $compound (predicted using ADJ matrix )\n"
...
printf "\nNearest neighbours of %s $compound (predicted using TENSOR matrix )\n"
...
printf "\nNearest neighbours of %s $compound (obtained from bigram_space)\n"
